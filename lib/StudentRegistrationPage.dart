...
class _StudentRegistrationPageState extends State<StudentRegistrationPage> {
  ...
  Future<void> fetchFacultiesAndDepartments() async {
    final facultiesResponse = await http
        .get(Uri.parse('http://192.168.1.114:8080/faculty/getAllFaculties'));
    final departmentsResponse = await http.get(
        Uri.parse('http://192.168.1.114:8080/department/getAllDepartments'));
  ...
  Future<void> fetchMajorsByDepartment(String department) async {
    final response = await http.get(Uri.parse(
        'http://192.168.1.114:8080/major/getAllMajorByDepartment?department=$department'));
