...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> signUpUser() async {
    final String apiUrl = 'http://192.168.1.46:8080/user/createUser';
    final String checkUserUrl = 'http://192.168.1.46:8080/user/getUser';
  ...
  Future<String> fetchUserId(String username) async {
    final String apiUrl =
        'http://192.168.1.46:8080/user/getUserID?userName=$username';
