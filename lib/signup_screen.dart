...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> signUpUser() async {
    final String apiUrl = 'http://192.168.43.199:8080/user/createUser';
    final String checkUserUrl = 'http://192.168.43.199:8080/user/getUser';
  ...
  Future<String> fetchUserId(String username) async {
    final String apiUrl =
        'http://192.168.43.199:8080/user/getUserID?userName=$username';
