...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> signUpUser() async {
    final String apiUrl = 'https://aa5d-176-29-208-189.ngrok-free.app/user/createUser';
    final String checkUserUrl = 'https://aa5d-176-29-208-189.ngrok-free.app/user/getUser';
