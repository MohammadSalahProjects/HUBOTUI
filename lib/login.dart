...
class LoginPage extends StatelessWidget {
  ...
  Future<String> fetchUserId(String username) async {
    final String apiUrl =
        'http://192.168.1.4:8080/user/getUserID?userName=$username';
  ...
  Future<String> fetchName(String userId) async {
    final String apiUrl =
        'http://192.168.1.4:8080/registerStudent/getName?userId=$userId';
  ...
  Future<void> loginUser(String username, String password, BuildContext context,
    ...
    final url = Uri.parse('http://192.168.1.4:8080/user/login');
